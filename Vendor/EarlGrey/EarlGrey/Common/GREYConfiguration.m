...
NSString *const GREYConfigKeyStrongVisibilityCheckEnabled = @"GREYConfigKeyStrongVisibilityCheckEnabled";
...
- (instancetype)init {
  ...
  if (self) {
    ...
    [self setDefaultValue:@YES forConfigKey:GREYConfigKeyStrongVisibilityCheckEnabled];
  }
  return self;
}
