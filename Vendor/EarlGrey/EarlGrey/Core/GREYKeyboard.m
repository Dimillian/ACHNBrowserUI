...
+ (void)initialize {
  if (self == [GREYKeyboard class]) {
    ...
    // PSPDFKit: changed for iOS 13 (https://github.com/PSPDFKit/PSPDFKit/pull/21288)
      if (iOS13_OR_ABOVE()) {
          gShiftKeyLabels = @[ @"shift", @"Shift", @"SHIFT", @"symbols", @"numbers", @"more", @"MORE" ];
      } else {
          gShiftKeyLabels = @[ @"shift", @"Shift", @"SHIFT", @"more, symbols", @"more, numbers", @"more", @"MORE" ];
      }
    ...
    if (!key) {
      ...
      if ([gAlphabeticKeyplaneCharacters characterIsMember:currentCharacter]) {
        ...
        if (![GREYKeyboard grey_isAlphabeticKeyplaneShown]) {
          // PSPDFKit: changed for iOS 13 (https://github.com/PSPDFKit/PSPDFKit/pull/21288)
          id moreLettersKey = [GREYKeyboard grey_waitAndfindKeyForCharacter:iOS13_OR_ABOVE() ? @"letters" : @"more, letters"];
          if (!moreLettersKey) {
            return [GREYKeyboard grey_setErrorForkeyNotFoundWithAccessibilityLabel:iOS13_OR_ABOVE() ? @"letters" : @"more, letters"
        ...
        if ([GREYKeyboard grey_isAlphabeticKeyplaneShown]) {
          // PSPDFKit: changed for iOS 13 (https://github.com/PSPDFKit/PSPDFKit/pull/21288)
          id moreNumbersKey = [GREYKeyboard grey_waitAndfindKeyForCharacter:iOS13_OR_ABOVE() ? @"numbers" : @"more, numbers"];
          if (!moreNumbersKey) {
            return [GREYKeyboard grey_setErrorForkeyNotFoundWithAccessibilityLabel:iOS13_OR_ABOVE() ? @"numbers" : @"more, numbers"
                                                                   forTypingString:string
                                                                             error:errorOrNil];
          }
