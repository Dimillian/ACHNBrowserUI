...
// Mac Catalyst doesn't include UIWebView. The test frameworks all have helpers and categories.
// They are unused but they would block compiling. For tests, we trick and just add an impl ourselves.
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
#pragma clang diagnostic ignored "-Wdeprecated-implementations"
#pragma clang diagnostic ignored "-Wincomplete-implementation"
@implementation UIWebView @end
...
- (void)grey_enableAccessibilityForDevice {
  ...
  #if TARGET_OS_IPHONE && !TARGET_OS_MACCATALYST
  reset = [swizzler resetInstanceMethod:@selector(_silentPressButton:)
